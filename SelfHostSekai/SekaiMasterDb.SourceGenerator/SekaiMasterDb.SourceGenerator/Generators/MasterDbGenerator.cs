...
namespace SekaiMasterDb.SourceGenerator
{
    ...
    public class MasterDbGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            while (stack.Count > 0)
            {
                ...
                foreach (var member in ns.GetMembers())
                {
                    ...
                    else if (member is INamedTypeSymbol typeSymbol)
                    {
                        ...
                        {
                            masterTypes[typeSymbol.Name.ToLowerInvariant()] = typeSymbol.ToDisplayString(SymbolDisplayFormat.FullyQualifiedFormat);
                        }
                    }
                }
            }
            ...
            mappedPairs.Sort((a, b) => string.Compare(a.prop, b.prop, StringComparison.InvariantCulture));
            ...
            {
                var cleanProp = pair.prop.StartsWith("@") ? pair.prop.Substring(1) : pair.prop;
        ...
        {
            var baseName = jsonFile.Substring(0, jsonFile.Length - 5).ToLowerInvariant();
